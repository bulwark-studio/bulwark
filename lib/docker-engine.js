...
const CONFIG_PATH = path.join(__dirname, '..', 'data', 'docker-config.json');
...
function loadConfig() {
  ...
  catch { return { socketPath: DEFAULT_SOCKET, host: null, port: null }; }
}
...
module.exports = {
  loadConfig, saveConfig, isAvailable,
